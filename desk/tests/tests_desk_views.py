...
class AccountTestCase(TestCase):
    ...
    def test_access_log_add_candidate_page(self):
        ...
        self.client.login(
            email=TESTS['name1']+'@gmail.com',
            password=TESTS['name1'])
        response = self.client.get(reverse('desk:add_candidates', args=(desk.id, )))
        self.assertEqual(response.status_code, TESTS['RightStatus'])
    ...
    def test_access_log_create_tickets_page(self):
        ...
        self.client.login(
            email=TESTS['name1']+'@gmail.com',
            password=TESTS['name1'])
        response = self.client.get(reverse('desk:create_tickets', args=(desk.id, )))
        self.assertEqual(response.status_code, TESTS['RightStatus'])
    ...
    def test_access_log_delete_desk_page(self):
        ...
        self.client.login(
            email=TESTS['name1']+'@gmail.com',
            password=TESTS['name1'])
        response = self.client.get(reverse('desk:delete_desk', args=(desk.id, )))
        self.assertEqual(response.status_code, TESTS['RightStatus'])
    ...
    def test_wrongStatus_open_desk_page(self):
        ...
        response = self.client.get(reverse('desk:open_desk', args=(desk.id, )))
        self.assertEqual(response.status_code, TESTS['RightStatus'])
        self.assertEqual(response.context["desk_status"], TESTS3['StatusClose'])
    ...
    def test_access_log_close_desk_page(self):
        ...
        self.client.login(
            email=TESTS['name1']+'@gmail.com',
            password=TESTS['name1'])
        response = self.client.get(reverse('desk:close_desk', args=(desk.id, )))
        self.assertEqual(response.status_code, TESTS['RightStatus'])
        self.assertEqual(response.context["desk_status"], TESTS3['StatusClose'])
    ...
    def test_wrongStatus_close_desk_page(self):
        ...
        response = self.client.get(reverse('desk:close_desk', args=(desk.id, )))
        self.assertEqual(response.status_code, TESTS['RightStatus'])
        self.assertEqual(response.context["desk_status"], TESTS3['StatusCreate'])
    ...
    def test_access_log_display_active_desk_page(self):
        ...
        self.client.login(
            email=TESTS['name1']+'@gmail.com',
            password=TESTS['name1'])
        response = self.client.get(reverse('desk:display_active_desk', args=(desk.id, )))
        self.assertEqual(response.status_code, TESTS['RightStatus'])
    ...
    def test_access_log_add_voters_page(self):
        ...
        self.client.login(
            email=TESTS['name1']+'@gmail.com',
            password=TESTS['name1'])
        response = self.client.get(reverse('desk:add_voters', args=(desk.id, )))
        self.assertEqual(response.status_code, TESTS['RightStatus'])
    ...
    def test_Tickets_add_voters_page(self):
        ...
        self.assertEqual(response.status_code, TESTS['RightStatus'])
        self.assertEqual(response.context["desk"].tickets_amount, TESTS['number1'])
    ...
    def test_access_log_delete_candidate_page(self):
        ...
        self.client.login(
            email=TESTS['name1']+'@gmail.com',
            password=TESTS['name1'])
        response = self.client.get(reverse('desk:delete_candidate', args=(candidate.id, desk.id,  )))
        self.assertEqual(response.status_code, TESTS['RightStatus'])
